...
app.get("/allproducts", async(req, res) => {
  try {
    let ressult = await db.query(`SELECT p.product_id, p.product_name, p.price, p.product_img, p.description, p.created_at, p.category_id, c.category_name FROM products AS p INNER JOIN categories AS c ON p.category_id = c.category_id`);
